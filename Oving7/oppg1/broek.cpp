...
Broek operator-(int tall, const Broek &denAndre) {  //første argument er ikke broek
 Broek hjelp;
 hjelp.settBroek(tall*denAndre.finnNevner()-denAndre.finnTeller(), denAndre.finnNevner());
 return hjelp;
}


Broek Broek::operator-(int tall) const { //første argument er broek
  Broek hjelp;
  hjelp.settBroek(this->finnTeller()-tall*this->finnNevner(), this->finnNevner());
 return hjelp;
}
