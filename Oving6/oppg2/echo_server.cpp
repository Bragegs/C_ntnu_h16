  ...
  void handle_request(shared_ptr<Connection> connection) {
    ...
    async_read_until(connection->socket, *read_buffer, "\r\n",
      ...
      if (message == "GET / HTTP/1.1") {
        ...
        const char hovedsiden[] =
                                   "<html>"
                                   "<head><title>En_side</title></head>"
                                   "<body><h1>Dette er hovedsiden</h1></body>"
                                   "</html>";
        
        write_stream << "HTTP/1.1 200\r\n" << endl;
        write_stream << hovedsiden;
        ...
        const char en_side[] =
                                   "<html>"
                                   "<head><title>En_side</title></head>"
                                   "<body><h1>Dette er en side</h1></body>"
                                   "</html>";
